  ...
  return (
    <div className='app__gallery flex__center'>
      <div className='app__gallery-content'>
        ...
        <p className='p__opensans' style={{color: "#AAA", marginTop: "2rem"}}>Sit Tellus Lobortis Sed Senectus Vivamus Molestie. Condimentum Voluptpat Morbi Facilisis Quam Scelerisque Sapien.</p>
